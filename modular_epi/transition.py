...
class Transition:
    """
    Defines a compartment and a rate to exit to that compartment, to be 
        used in the compartment that transitions to this OutCompartment.
    """
    ...
    def __init__(self, length, iters, compt=None, param=None, name=""):
        ...
        Parameters:
            ...
            name (str): the name of this out compartment. Should be 
                formatted as {origin_compt} - {parameter} -> {out_compt}
        """
...
class Transmission:
    """
    Defines a compartment and the rate of infection by that compartment,
        to be used in the SusceptibleCompartment that is infected by this 
        compartment.
    """
    ...
    def __init__(self, N, compt=None, param=None, name=""):
        ...
        Parameters:
            ...
            name (str): the name of this InfectiousCompartment. Format 
                is "{infectious_compt} - {parameter} -* {infected_comp}"
        """
        self.N = N
        self.compartment = compt
        self.parameter = param
